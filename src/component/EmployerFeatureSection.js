    ...
    return (
        <div className="w-full max-w-[1440px] h-auto mx-auto mt-20 sm:mt-32 lg:mt-60 px-4 sm:px-8 md:px-16 lg:px-24">
            <div className="w-full mx-auto">
                <h1 className="text-3xl sm:text-4xl lg:text-[48px] font-semibold leading-tight lg:leading-[50px] text-center mb-4 lg:mb-6">
                    Key Features
                </h1>

                <p className=" text-base sm:text-lg lg:text-[20px] font-medium leading-relaxed lg:leading-[30px] text-center mb-8 lg:mb-16 px-4 sm:px-4 ">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-12 sm:gap-6 lg:gap-4 pt-4 pb-8 sm:pb-0 sm:h-[10.25rem]">
                    ...
                    <div className="w-full sm:w-1/3 flex flex-col justify-center items-center gap-4 text-center">
                        <Image
                            ...
                            quality={100}
                        />
                        <h2 className="text-xl sm:text-2xl lg:text-[2rem] font-medium w-full text-center leading-tight lg:leading-8">
