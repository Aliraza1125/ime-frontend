...
const HeroSection = () => {
    ...
    return (
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-24 h-auto flex flex-col lg:flex-row justify-between py-6">
            <div className="w-full lg:w-6/12 h-auto flex justify-start lg:justify-end gap-6 pr-6 lg:pr-10 mb-8 lg:mb-0">
                <div className="flex flex-col gap-4">
                    {/* Heading */}
                    <h1 className="font-clash-display font-semibold text-[30px] md:text-6xl lg:text-[80px] leading-tight lg:leading-[85px] text-start md:text-start ">
                        Improve your company&apos;s well-being with
                        <span className="bg-text-gradient bg-clip-text text-transparent"> iMe!</span>
                    </h1>

                    {/* Description */}
                    <p className="font-normal text-[15px] lg:text-lg leading-[20px] text-start md:text-left mb-3">
                    ...
                    <form 
                        ...
                        className="hidden sm:flex w-full sm:w-[27rem] pl-6 p-2.5 flex-row border border-[#E1E1E1] justify-between items-center rounded-[1.25rem] gap-3 sm:gap-0"
                    >
                        <input 
            ...
            <div className="relative lg:absolute lg:right-0 w-full lg:w-6/12">
                ...
                {/* Mobile Image */}
                <Image 
                    src="/Images/Leaderboard-mobile1.svg" 
                    alt="Leaderboard Illustration Mobile" 
                    width={0} 
                    height={0} 
                    sizes="100%" 
