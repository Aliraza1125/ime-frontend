        ...
        <>
            <div className="w-full max-w-[1440px] h-auto mx-auto mt-16 sm:mt-20 lg:mt-32 px-4 sm:px-8 md:px-16 lg:px-24">
                <div className="w-full mx-auto">
                    <h1 className="text-3xl sm:text-4xl lg:text-[48px] font-semibold leading-tight sm:leading-snug lg:leading-[50px] text-start sm:text-center mb-4 sm:mb-6">
                        Key Features
                    </h1>

                    <p className="text-[15px] sm:text-lg lg:text-[20px] font-medium leading-[25px] lg:leading-[30px] text-start sm:text-center pr-16 sm:pr-0 lg:pr-0 mb-8 sm:mb-12 lg:mb-16 ">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-12 sm:gap-4 pt-4">
                        ...
                        <div className="w-full sm:w-1/3 flex sm:flex-col justify-center items-center gap-6 sm:gap-4 text-center">
                            <Image
                                ...
                                quality={100}
                            />
                            <h2 className="text-2xl sm:text-2xl lg:text-[2rem] font-medium w-full text-start sm:text-center leading-tight lg:leading-8">
