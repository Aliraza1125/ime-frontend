...
const EmployerIntegrationSection = () => {
    return (
        <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 md:px-8 lg:px-24 lg:py-24">
            <div className="flex flex-col items-start lg:flex-row py-10 sm:py-16 lg:py-20 gap-8 lg:gap-20">
                {/* Text Content */}
                <div className="w-full lg:w-[40%] flex flex-col gap-6 sm:gap-8 lg:gap-10 lg:pt-12">
                    <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-semibold leading-tight sm:leading-snug lg:leading-[50px] text-start lg:text-left">
                        Seamless <br className="hidden sm:block" /> Integration
                    </h1>
                    <p className="font-medium text-[15px] sm:text-lg lg:text-lg leading-[25px] lg:leading-[33px] w-full lg:w-6/6 font-satoshi opacity-50 text-start lg:text-left pr-8 sm:pr-0">
                ...
                {/* Image Container */}
                <div className="w-full lg:w-[60%] flex justify-center lg:justify-start items-start">
                    <div className="w-full max-w-2xl lg:max-w-none">
                        <Image
                            ...
                            className="w-full lg:w-[919px] h-auto object-contain"
                            priority
                            quality={100}
                        />
                    </div>
