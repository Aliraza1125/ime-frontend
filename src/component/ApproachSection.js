...
const ApproachSection = () => {
    return (
        <div className="w-full max-w-[1440px] h-auto mx-auto  sm:mt-24 lg:mt-[9rem] px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12">
                {/* Text Content */}
                <div className="w-full lg:w-1/2">
                    <h1 className="font-semibold text-[30px] sm:text-[45px] lg:text-[68px] leading-tight lg:leading-[70px] text-left">
                        Well-being in motion:{' '}
                        <span className=" bg-theme-gradient text-transparent bg-clip-text">
                            A circular
                        </span>{' '}
                    ...
                    <p className="font-normal text-[15px]  sm:text-lg lg:text-[20px] leading-[25px] lg:leading-[40px] mt-4 lg:mt-6 text-left">
