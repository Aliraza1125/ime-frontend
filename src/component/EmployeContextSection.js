    ...
    return (
        <div className="w-full max-w-[1440px] mx-auto px-6 sm:px-8 md:px-8 lg:px-24">
            <div className="flex flex-col  lg:flex-row gap-8 py-10 sm:py-16 lg:py-20">
                <div className="w-full lg:w-1/2 flex flex-col  gap-6 sm:gap-8 lg:gap-10 lg:pt-32 ">
                    ...
                    <p className="font-medium text-base sm:text-lg lg:text-xl leading-relaxed lg:leading-[33px] w-full lg:w-5/6 font-satoshi opacity-50 pr-12 sm:pr-0 lg:pr-0">
